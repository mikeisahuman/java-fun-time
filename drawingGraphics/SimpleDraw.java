// SimpleDraw : main file for drawing everything
...
public class SimpleDraw extends JPanel implements Runnable {    
    ...
    private final int FRAME_DELAY = 50; // _!_ 50 ms = 20 FPS _!_
    ...
    public static void main(String args[]) {
        ...
        JFrame frame = new JFrame("Graphics! -- all types of crazy stars!!");
